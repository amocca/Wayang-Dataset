...
Rasio pembagian train/val/test: **[isi di sini, mis. 70/15/15]**. Pembagian dilakukan secara stratified per kelas untuk menjaga proporsi antar kelas tetap konsisten di setiap subset.
